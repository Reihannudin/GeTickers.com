    ...
    <div class="bg-white position-fixed w-100" style="z-index: 99;">
        <div class="justify-content-between mx-5 align-items-center d-flex" style="height: 80px">
            <div class="d-flex">
                ...
                <div class="mt-auto mb-1 mx-3 d-flex">
                    <div class="d-flex gap-2 pe-2 me-3 mt-auto "  style="border-right: 1px solid #EEEEEE">
                        <div class="d-flex ">
                            <div class="d-flex">
                    ...
                    <div class="d-flex  gap-2 pe-2 mt-auto "  style="border-right: 1px solid #EEEEEE">
                        <div class="d-flex ">
                            <div class="d-flex">
                                <div style="height: 25px ; border-radius: 100%">
